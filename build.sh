gcc game/game.c -o bestassert_game
...
gcc -fPIC -fpic any/bestassert.o lin/bestassert.o lin/signals.o -shared -Wl,--out-implib,libbestassert.lib -o libbestassert.so
